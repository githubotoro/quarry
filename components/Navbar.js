				...
				>
					...
					>
						<motion.svg
                            ...
                            ${
								router.asPath === "/"
									? "fill-isRedDarkEmphasis hover:fill-isRedDark"
									: "fill-isGrayDark hover:fill-isGreenDarkEmphasis"
							}
                        `}
						>
					...
					>
						<motion.svg
                            ...
                            ${
								router.asPath === "/savegames"
									? "fill-isRedDarkEmphasis hover:fill-isRedDark"
									: "fill-isGrayDark hover:fill-isBlueDarkEmphasis"
							}
                        `}
						>
					...
					<Link
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com/githubotoro/quarry"
					>
						<motion.svg
							whileTap={{
								scale: 0.9,
